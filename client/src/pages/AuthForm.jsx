          ...
          <form onSubmit={handleSubmit}>
            <div className="flex flex-col items-center">
              <button
                onClick={googleLogin}
                type="button"
                className={`w-full max-w-xs font-bold cursor-pointer shadow-md rounded-lg py-3 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow-lg ${
                  theme === "light"
            ...
            <div className="mx-auto max-w-xs">
              {formState === "Sign up" ? (
                ...
                <>
                  ...
                  <button
                    className={`mt-5 tracking-wide font-semibold w-full py-4 rounded-lg transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none shadow-md hover:shadow-lg ${
                      theme === "light"
